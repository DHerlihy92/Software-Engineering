...
namespace WindowsFormsApp1
{
    class Payment
    {
        ...
        //Saves a Payment to the Payments file
        public void addPayment()
        {
            ...
            String strSQL2 = "UPDATE (SELECT pay.Amount_Paid cost1, pay.CustID id1, res.Res_Cost cost2, res.CustID id2 FROM Payments pay," + 
                " Reservations res WHERE pay.ResNo = res.ResNo) SET cost1 = cost2, id1 = id2 ";
